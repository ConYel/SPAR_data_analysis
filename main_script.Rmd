...
targets_file <- fread(targ_path) %>%
  as_tibble() %>%
  dplyr::select(Run, classification) 
...
writting_path <- str_glue("/home/rstudio/SPAR_data_analysis/results_matrix_{date}_SPAR.txt")
...
plotMDS(lcpm_TMM,labels = targets_file$classification,
